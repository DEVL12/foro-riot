...
<body id="registration_login_page" background="<?= base_url() ?> assets/images/bg.jpg">
	<!-- start: header -->
		...
		<div id="content">
			<div class="wrapper">
				...
				<div class="navigation">
					...
					<!-- start: nav_bit -->
					<a href="index.html">Foro Riot Games</a>
					<!-- end: nav_bit -->
					<!-- start: nav_sep_active -->
					<span class="nav-spacer">&rsaquo;</span>
					<!-- end: nav_sep_active -->
					<!-- start: nav_bit_active -->
					<span class="active">Iniciar sesión</span>
					<!-- end: nav_bit_active -->
				</div>
				<!-- end: nav -->
				<br />
					...
					<table border="0" cellspacing="0" cellpadding="5" class="tborder" id="log_reg_table"
						...
						<tr>
							<td class="trow1" colspan="2" align="center"><label
								...
								<br><br>
								<div align="center"><input type="submit" class="button log_reg_btn" name="submit" value="Sign In"/>
								</div>
							</td>
						</tr>
					</table>
