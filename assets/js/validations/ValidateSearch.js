...
function ValidateSearch(keywordSearch = '', keywordSearchType = '',
                        forumToSearch = '',
                        topicSearch = '',
    ...
    var keywordSearchOK = CheckIfEmpty(keywordSearch); 
